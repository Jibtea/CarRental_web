...
import Car from "@/db/models/Provider";
                    ...
                    <form action={addCar}>
                        ...
                        <div className="flex items-center w-1/2 my-2">
                            ...
                            <input type="number" required id="largebags" name="largebags" placeholder="2" min={0} max={10}
                                className="bg-white border-2 border-gray-200 rounded w-full p-2
                            text-gray-700 focus:outline-none focus:border-blue-400"/>
                            <label className="w-auto block text-gray-700 pr-4" htmlFor="smallbags">
                                Small Bags</label>
                        ...
                        <button type="submit" className="bg-blue-500 hover:bg-blue-700 text-white p-2 rounded"></button>
                    </form>
                    : null
            }
        </main>
